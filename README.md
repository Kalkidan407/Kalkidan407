...
Instead, I want to **learn as much as I can**, try new things, and build the kind of flexibility that allows me to create anything — whether it's web, mobile, or blockchain.

---

### 🌱 Currently Learning
- Flutter & Dart
- JavaScript (core concepts & web development)
- Blockchain fundamentals (just getting started!)
